  ...
  "params": 
{
    ...
    "name":"",            //(必填)(string) 用户名称,冗余字段
    "logo":12,   //(必填)(int) 头像logo
    "phoneCode":"", // (必填)(string) 手机验证码
    "code":"", // (必填)(string) 图形验证码
    "tel":"",//(必填)(string) 推荐人电话
    "customerType":"",//用户类型;货主(customer_cargo)还是车主(customer_car_owner)
...
{
      "name":"",//(必填)(string) 企业全称
      "legalerIdCardFront":12,//法人身份证正面照
  	  "legalerName":"张红",//(必填)(string) 法人姓名
  	  "businessLicense":12,//(必填)(int) 营业执照 
      "legalerIdCardNo":"420922198011272852",//(必填)(string) 法人证件号
      "creditCode":"KDOO124657788X",//(必填)(string) 信用代码
      ...
      "county":"中水县",//(必填)(string) 县
      "addressDetail":"",//(必填)(string) 详细地址
      "customerType":""//(必填);字典值;企业key(certification_organize)或个人(certification_person)
  }
}
```
  ...
  "params": 
{
	...
	"phoneCode":"678909",//(必填)(string) 手机验证码
    "pwd":"123456",      //(必填)(string) 用户密码
...
``` json
{
	"params": 
    {
		...
		"pwd":"123456",                  //(必填)(string) 登录密码
	    "phoneCode":"123456"           //(必填)(string) 修改手机验证码
	 },
   "token": "string"
}
```  
