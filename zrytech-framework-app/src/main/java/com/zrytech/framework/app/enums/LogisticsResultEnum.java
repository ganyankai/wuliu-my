...
public enum LogisticsResultEnum {
    ...
    INDENT_STATUS_ERROR(116,"订单未分配车辆路线"),
    INDENT_SIGN_ERROR(117,"货物未装货不能签收"),
    INDENT_CHANGE_ERROR(118,"订单未确定或已支付!"),
    LOGIN_COUNTER_EXISTED(149,"用户名已存在"),
    GOODS_SOURCE_UP(150,"货源报价中,不能删除"),
    NAME_IS_EXIST(591, "名称已存在"),
    DELETE_WAYBILL_FAIL(110, "订单运输中,删除订单失败!"),
    PERMISSED_NOT_FAIL(111, "权限不足!"),
    CANCEL_NOT_FAIL(113, "订单不是待生成状态!"),
